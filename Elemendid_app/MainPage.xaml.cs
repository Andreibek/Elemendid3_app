...
namespace Elemendid_app
{
    ...
    {
        Button editor_btn, timer_btn, box_btn, cliker_btn,datepiker_btn,ss_btn,rgb_btn; 
        public MainPage()

        {
            ...
            {
                Children = {editor_btn,timer_btn,box_btn,cliker_btn, datepiker_btn, ss_btn, rgb_btn }
            };
